				...
				<TextInput style={{height: 40}}
				  ...
				  renderItem={({item}) =>
					  ...
					  <Card>
					  	...
					  	<CardItem cardBody>
			              <Image source={{uri: item.imgurls.split(",")[0]?item.imgurls.split(",")[0]:'https://upload.wikimedia.org/wikipedia/commons/d/de/Bananavarieties.jpg'}} style={{height: 100, width: null, flex: 1}}/>
			            </CardItem>
			            <CardItem cardBody>
